...
type PartyIconProps = React.SVGAttributes<SVGSVGElement>

export default function PartyIcon(props: PartyIconProps) {
    const { className } = props

    return (
        <svg width="10rem" height="10rem" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className={`iconify iconify--noto ${className}`} preserveAspectRatio="xMidYMid meet">
